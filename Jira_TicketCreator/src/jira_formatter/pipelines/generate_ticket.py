...
from jira_formatter.agents.orchestrator import AgentConfig, MultiAgentOrchestrator
from jira_formatter.llm.gemini import GeminiClient
from jira_formatter.llm.prompts import PromptBundle, default_prompts
from jira_formatter.rag.retriever import JiraIssueRetriever
...
class TicketGenerator:
    ...
    # This is a function to generate a Jira card from a user request using RAG + multi-agent refinement.
