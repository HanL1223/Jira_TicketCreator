...
from jira_formatter.llm.prompts import PromptBundle, default_prompts
...
class AgentConfig:
    ...
    """
    enabled: bool = True
    passes: int = 1  # One full cycle: product -> technical -> qa


class MultiAgentOrchestrator:
    """
    Coordinates multiple agent-style refinement passes on a draft Jira card.

    This keeps the "multi-agent architecture" real and demo-able without over-engineering.
    """
    ...
    # This is a function to refine a draft Jira card using product/tech/qa passes.
    ...
    # This is a function to execute one "agent" prompt against the LLM.
