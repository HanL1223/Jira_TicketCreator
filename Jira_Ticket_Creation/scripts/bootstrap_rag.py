...
from core.datasource import SourceConfig, create_issue_source
from rag.embeddings import GeminiEmbeddingClient, GeminiEmbeddingConfig
from rag.indexer import IndexingConfig, JiraIssueIndexer
from rag.vectorstore import ChromaConfig, ChromaVectorStore
...
def main() -> None:
    ...
    embedder = GeminiEmbeddingClient(GeminiEmbeddingConfig(api_key=api_key))
